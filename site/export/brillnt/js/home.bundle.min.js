    ...
    value: function init() {
      ...
      this.indicators.forEach(function (indicator, index) {
        indicator.addEventListener('click', function () {
          ...
          var step = +indicator.getAttribute('data-step-indicator-num');
          step = step - 1;

          // make the slides move forward along the z-axis so it looks like the slides are moving toward the user.
          gsap/* gsap */.os.to(_this.slides, {
            duration: 1,
            opacity: function opacity(i) {
              return "".concat(step === i ? 1 : 0);
            },
            z: function z(i) {
              return "".concat(step === i ? 0 : 750, "px");
            },
            y: 0,
            scale: function scale(i) {
              return "".concat(step === i ? 1 : 0.5);
            },
            ease: 'power4.inOut',
            stagger: {
              each: 0.1,
