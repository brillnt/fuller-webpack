...
var SimpleImageSlider = /*#__PURE__*/function () {
  ...
  return simple_image_slider_createClass(SimpleImageSlider, [{
    ...
    value: function init() {
      ...
      tl.set(this.images, moves.ready).to(this.images[0], moves.show).to(this.images[0], moves.hide).to(this.images[1], moves.show, '-=1').to(this.images[1], moves.hide).to(this.images[2], moves.show).to(this.images[2], moves.hide);
    }
  }]);
}();
...
onReady(function () {
  ...
  new TextAnimateSections(['first-reveal', 'home-model-reveal', {
    id: 'swipe-copy-1',
    gsap: {
      delay: 0.5
    },
