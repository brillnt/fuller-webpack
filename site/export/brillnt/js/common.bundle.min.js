...
var CommandCenterGraphic = /*#__PURE__*/(/* runtime-dependent pure expression or super */ /^(158|359)$/.test(__webpack_require__.j) ? (function (_Base) {
  ...
  function CommandCenterGraphic(elementId) {
    ...
    _this.defaultConfig = {
      ...
      specialIterationDelay: 1500,
      // Delay after special iterations (milliseconds)
      staggerDelay: 0.022,
      // Delay between each tile animation (seconds)
      ...
      specialDuration: 1,
      // Easing
      revealEasing: 'power4.out',
      // Easing for reveal animation
      regularEasing: 'expo.out',
      // Easing for regular iterations
      specialEasing: 'power4.inOut',
      // Easing for special iterations

      // Pattern
      specialIterationInterval: 3,
      // Every nth iteration is special
    ...
    _this.config = _objectSpread(_objectSpread({}, _this.defaultConfig), config);
    if (!elementId) {
  ...
  return _createClass(CommandCenterGraphic, [{
    ...
    value: function init() {
      ...
      _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(this.tiles, {
        ...
        onComplete: function onComplete() {
          _this2.log("Reveal animation complete. Starting tile movement sequence...");
          // After the reveal animation completes, start our animation sequence
          setTimeout(function () {
            return _this2.startAnimationSequence();
          }, _this2.config.animationDelay);
        }
      });
    ...
    value: function startAnimationSequence() {
    ...
    key: "animateNextIteration",
    value: function animateNextIteration() {
      var _this3 = this;
      this.iterationCount++;
      var isSpecialIteration = this.iterationCount % this.config.specialIterationInterval === 0;
      this.log("Animation iteration ".concat(this.iterationCount, ", Special: ").concat(isSpecialIteration));
      if (isSpecialIteration) {
        ...
        setTimeout(function () {
          return _this3.animateNextIteration();
        }, this.config.specialIterationDelay);
      } else {
    ...
    value: function moveTiles(direction) {
      ...
      var easing = options.easing || this.config.regularEasing;
      var duration = options.duration || this.config.regularDuration;
      this.log("Moving tiles ".concat(direction, " with ").concat(easing, " easing"));
      var positions = this.getTilePositions();

      // Get the appropriate movement pattern based on direction
      var moveTargets = this.getMovementPattern(direction);
      ...
      this.tiles.forEach(function (tile, index) {
        ...
        _this4.log("Moving tile ".concat(index, " to ").concat(targetPosition.name, " (position ").concat(moveTargets[index], ")"));
        ...
        _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(tile, {
          ...
          onStart: function onStart() {
            _this4.log("Starting ".concat(direction, " animation for tile ").concat(index));
          },
          onComplete: function onComplete() {
            _this4.log("Completed ".concat(direction, " animation for tile ").concat(index));
          }
        });
      });
    }
    ...
    key: "getMovementPattern",
    value: function getMovementPattern(direction) {
    ...
    value: function getTilePositions() {
      ...
      positions.forEach(function (pos) {
        var tile = _this5.tiles[pos.index];
        var rect = tile.getBoundingClientRect();
        pos.x = rect.left;
        pos.y = rect.top;
        _this5.log("Position ".concat(pos.name, " (").concat(pos.index, "): (").concat(pos.x, ", ").concat(pos.y, ")"));
      });
      return positions;
    }
