...
/* harmony export */   A: () => (/* binding */ AnimatePath)
/* harmony export */ });
...
var AnimatePath = /*#__PURE__*/(/* runtime-dependent pure expression or super */ /^96[24]$/.test(__webpack_require__.j) ? (function () {
  function AnimatePath(elementId) {
    ...
    this.element = (0,_utils_helpers_js__WEBPACK_IMPORTED_MODULE_0__/* .selectId */ .Ge)(elementId);
...
var FullerAngleWatcher = /*#__PURE__*/(/* runtime-dependent pure expression or super */ /^96[24]$/.test(__webpack_require__.j) ? (function () {
  function FullerAngleWatcher(fullerCubesSelector) {
    _classCallCheck(this, FullerAngleWatcher);
    if (!fullerCubesSelector) return;
    this.fullerCubes = (0,_utils_helpers_js__WEBPACK_IMPORTED_MODULE_0__/* .selectAll */ .Ub)(fullerCubesSelector);
    this.baseXCut = 0.067;
