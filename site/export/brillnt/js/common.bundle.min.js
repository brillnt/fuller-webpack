...
/* harmony export */ });
if (/^96[24]$/.test(__webpack_require__.j)) {
...
var ContactForm = /*#__PURE__*/(/* runtime-dependent pure expression or super */ /^96[24]$/.test(__webpack_require__.j) ? (function (_Base) {
  function ContactForm(elementId) {
    ...
    _this.multiSelectElem = (0,_utils_helpers_js__WEBPACK_IMPORTED_MODULE_0__/* .selectId */ .Ge)('Home-Model-Interest');
    _this.multiSelectLabel = _this.element.querySelector('#multi-select-label');
  ...
  return _createClass(ContactForm, [{
    ...
    value: function init() {
      var _this2 = this;
      if ((0,_utils_helpers_js__WEBPACK_IMPORTED_MODULE_0__/* .isMobile */ .Fr)()) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ FullerAngleWatcher)
/* harmony export */ });
if (/^96[24]$/.test(__webpack_require__.j)) {
	/* harmony import */ var _utils_helpers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(406);
}
...
var FullerAngleWatcher = /*#__PURE__*/(/* runtime-dependent pure expression or super */ /^96[24]$/.test(__webpack_require__.j) ? (function (_Base) {
  function FullerAngleWatcher(fullerCubesSelector) {
    var _this;
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    _classCallCheck(this, FullerAngleWatcher);
    // Handle the case where options is a boolean (for backward compatibility)
    var debug = typeof options === 'boolean' ? options : options.debug || false;
    _this = _callSuper(this, FullerAngleWatcher, [debug]);
    if (!fullerCubesSelector) return _possibleConstructorReturn(_this);
    ...
    _this.fullerCubes = (0,_utils_helpers_js__WEBPACK_IMPORTED_MODULE_0__/* .selectAll */ .Ub)(fullerCubesSelector);
    _this.baseXCut = 0.067;
    _this.baseYCut = _this.baseXCut * Math.tan(33.7 * Math.PI / 180);
    _this.init();
    return _this;
  }
  _inherits(FullerAngleWatcher, _Base);
  return _createClass(FullerAngleWatcher, [{
    key: "init",
    value: function init() {
      var _this2 = this;
    ...
    value: function updateCubeClipPath(element) {
      ...
      if (inset === 0) {
        ...
        var insetXPct = "".concat((inset / width * 100).toFixed(4), "%");
        var insetYPct = "".concat((inset / height * 100).toFixed(4), "%");

        // Create clip path with inset adjustment
        clipPath = "polygon(\n        ".concat(insetXPct, " ").concat(insetYPct, ",\n        calc(100% - ").concat(xCutPct, " - ").concat(insetXPct, ") ").concat(insetYPct, ",\n        calc(100% - ").concat(insetXPct, ") calc(").concat(yCutPct, " + ").concat(insetYPct, "),\n        calc(100% - ").concat(insetXPct, ") calc(100% - ").concat(insetYPct, "),\n        calc(").concat(xCutPct, " + ").concat(insetXPct, ") calc(100% - ").concat(insetYPct, "),\n        ").concat(insetXPct, " calc(100% - ").concat(yCutPct, " - ").concat(insetYPct, ")\n      )");
      }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ ImageWipeReveal)
/* harmony export */ });
if (/^96[24]$/.test(__webpack_require__.j)) {
...
var ImageWipeReveal = /*#__PURE__*/(/* runtime-dependent pure expression or super */ /^96[24]$/.test(__webpack_require__.j) ? (function (_Base) {
  function ImageWipeReveal(selector) {
    var _this;
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var debug = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    _classCallCheck(this, ImageWipeReveal);
    ...
    _this.elements = (0,_utils_helpers_js__WEBPACK_IMPORTED_MODULE_1__/* .selectAll */ .Ub)(selector);
    _this.images = Array.from(_this.elements);
    _this.init();
    return _this;
  }
  _inherits(ImageWipeReveal, _Base);
  return _createClass(ImageWipeReveal, [{
    key: "init",
    value: function init() {
      var _this2 = this;
      if (this.images) {
        ...
        this.images.forEach(function (image, i) {
          ...
          _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.set(image, {
          ...
          if (_this2.options.direction === 'right') {
            ...
            _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.fromTo(image, {
...
var TextAnimateLines = /*#__PURE__*/(/* runtime-dependent pure expression or super */ 359 != __webpack_require__.j ? (function (_Base) {
  function TextAnimateLines(selector) {
    var _this;
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var debug = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    if (typeof selector === 'string' && !selector.match(/[.#\[\]]/)) {
      ...
      var element = (0,helpers/* selectId */.Ge)(selector);
      if (!element) {
        _this.log("Element with ID ".concat(selector, " not found."));
        return _possibleConstructorReturn(_this);
      }
      _this.containers = [element];
    } else {
      // Otherwise, assume it's a CSS selector
      _this.containers = Array.from((0,helpers/* selectAll */.Ub)(selector) || []);
      if (_this.containers.length === 0) {
        _this.log("No elements found with selector \"".concat(selector, "\"."));
        return _possibleConstructorReturn(_this);
      }
    }
    _this.options = _objectSpread({
  ...
  return _createClass(TextAnimateLines, [{
    ...
    value: function wrapLineContents() {
      var _this2 = this;
      this.allLinesCopy = [];
      this.log("Wrapping line contents for ".concat(this.splitInstances.length, " split instances"));

      // Count lines that have already been processed to avoid duplicates
      var processedLines = new Set();
      this.splitInstances.forEach(function (instance, instanceIndex) {
        if (instance.lines && instance.lines.length > 0) {
          _this2.log("Instance ".concat(instanceIndex, " has ").concat(instance.lines.length, " lines"));
          instance.lines.forEach(function (line, lineIndex) {
            // Skip if this line has already been processed
            if (processedLines.has(line)) {
              _this2.log("Skipping already processed line at index ".concat(lineIndex));
              return;
            }
            ...
            if (!line || !line.parentNode) {
              _this2.log("Invalid line at index ".concat(lineIndex, " - skipping"));
              return;
            }
            ...
            if (line.textContent.trim() === '.' && lineIndex > 0) {
              ...
              if (!line.firstChild) {
                _this2.log("Line at index ".concat(lineIndex, " has no content to wrap - skipping"));
                return;
              }
          ...
          _this2.log("WARNING: Instance ".concat(instanceIndex, " has no lines"));
        }
      });
      this.log("Created ".concat(this.allLinesCopy.length, " line copy wrappers in total"));
    }
  }, {
    ...
    value: function splitRevealElements() {
      ...
      this.splitInstances = [];
      this.allLinesCopy = [];
      this.log("Splitting text in ".concat(this.containers.length, " containers"));

      // Direct DOM check - what do we actually have to start with?
      this.containers.forEach(function (container, containerIndex) {
        _this3.log("Container ".concat(containerIndex, " HTML structure before splitting:"), container.innerHTML.substring(0, 100) + '...');

        // Check what reveal elements we're finding
        var revealElements = container.querySelectorAll(TEXT_REVEAL_SELECTOR);
        _this3.log("Container ".concat(containerIndex, " found ").concat(revealElements.length, " [data-reveal] elements"));

        // Log each reveal element
        revealElements.forEach(function (el, i) {
          _this3.log("Reveal element ".concat(i, " text: \"").concat(el.textContent.substring(0, 50), "...\""));
        });
      });
      ...
      this.containers.forEach(function (container, containerIndex) {
        ...
        if (revealElements.length === 0) {
          _this3.log("WARNING: Container ".concat(containerIndex, " has no [data-reveal] elements!"));
        }
        revealElements.forEach(function (element, elementIndex) {
          _this3.log("Splitting element ".concat(elementIndex, " with types: ").concat(_this3.options.types));

          // Store the original HTML for debugging
          var originalHTML = element.innerHTML;
          _this3.log("Original HTML before split: ".concat(originalHTML.substring(0, 100), "..."));
          var splitInstance = new animation/* SplitType */.BX(element, {
            types: _this3.options.types
          });

          // Log the resulting structure
          _this3.log("After split, element now has:", splitInstance.lines ? "".concat(splitInstance.lines.length, " lines") : 'no lines', splitInstance.words ? "".concat(splitInstance.words.length, " words") : 'no words', splitInstance.chars ? "".concat(splitInstance.chars.length, " chars") : 'no chars');

          // Directly inspect the DOM to see what SplitType did
          _this3.log("Element HTML after split: ".concat(element.innerHTML.substring(0, 100), "..."));

          // Check if lines were actually created
          if (!splitInstance.lines || splitInstance.lines.length === 0) {
            _this3.log("WARNING: SplitType did not create any lines for element ".concat(elementIndex, "!"));
            _this3.log("Check if element contains actual text content and if CSS is correct.");
          }
      ...
      this.log("After wrapping, we have ".concat(this.allLinesCopy.length, " .line__copy elements"));

      // Check how many are actually in the DOM
      var allLinesCopyInDOM = document.querySelectorAll('.line__copy');
      this.log("DOM contains ".concat(allLinesCopyInDOM.length, " .line__copy elements"));
    ...
    value: function createScrollTriggerAnimation() {
      ...
      var allLinesInDOM = document.querySelectorAll('.line');
      var allLinesCopyInDOM = document.querySelectorAll('.line__copy');
      this.log("DIRECT DOM CHECK: Found ".concat(allLinesInDOM.length, " .line elements and ").concat(allLinesCopyInDOM.length, " .line__copy elements in the DOM"));
      ...
      if (allLinesCopyInDOM.length === 0) {
        ...
        this.containers.forEach(function (container, index) {
          ...
          var directLineCopies = Array.from(container.querySelectorAll('.line__copy'));
          if (directLineCopies.length > 0) {
            _this4.log("Found ".concat(directLineCopies.length, " .line__copy elements directly in container ").concat(index));
            ...
            var scrollTriggerConfig = {
              ...
              start: "top 60%",
              once: true,
              markers: _this4.debug
            };

            // Set the initial state directly
            directLineCopies.forEach(function (copy) {
            ...
            _this4.scrollTriggers.push(tl.scrollTrigger);
            _this4.log("Created direct animation for container ".concat(index));
          } else {
            _this4.log("No .line__copy elements found directly in container ".concat(index));
          }
        });
        return;
      }
      ...
      // Debug info
      this.log("Using stored references: ".concat(this.allLinesCopy.length, " line copies"));

      // Check if our stored references are still valid
      var validStoredCopies = this.allLinesCopy.filter(function (copy) {
        return copy && copy.parentNode && document.body.contains(copy);
      });
      this.log("Of our ".concat(this.allLinesCopy.length, " stored line copies, ").concat(validStoredCopies.length, " are still valid in the DOM"));
      ...
      this.containers.forEach(function (container, index) {
        ...
        var containerLineCopies = Array.from(container.querySelectorAll('.line__copy'));
        _this4.log("Container ".concat(index, " has ").concat(containerLineCopies.length, " line copies via direct DOM query"));

        // Skip if no line copies
        if (containerLineCopies.length === 0) {
          _this4.log("Skipping container ".concat(index, " - no line copies found in DOM"));
          return;
        }
        ...
        animation/* gsap */.os.set(containerLineCopies, {
          y: '100%'
        });

        // Create the animation
        tl.to(containerLineCopies, _objectSpread({
          duration: 1.2,
          y: '0%',
          stagger: 0.1,
          ease: "expo.out"
        ...
        _this4.scrollTriggers.push(tl.scrollTrigger);
        _this4.log("Created animation for container ".concat(index, " with ").concat(containerLineCopies.length, " line copies"));
      });
    }
  }, {
    key: "handleResize",
...
var _excluded = (/* runtime-dependent pure expression or super */ 359 != __webpack_require__.j ? (["id"]) : null);
...
var TextAnimateSections = /*#__PURE__*/(/* runtime-dependent pure expression or super */ 359 != __webpack_require__.j ? (function (_Base) {
    ...
    value: function init() {
      ...
      this.sections.forEach(function (params) {
        if (typeof params === 'string') {
          new TextAnimateLines(params, {}, _this2.debug);
...
var SplitType = /*#__PURE__*/(/* runtime-dependent pure expression or super */ /^96[24]$/.test(__webpack_require__.j) ? (function () {
