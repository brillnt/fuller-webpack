"use strict";
(self["webpackChunkfuller_webpack_app"] = self["webpackChunkfuller_webpack_app"] || []).push([[76],{
...
var Base = /*#__PURE__*/(/* runtime-dependent pure expression or super */ 152 != __webpack_require__.j ? (function () {
  function Base() {
  ...
  return _createClass(Base, [{
    ...
    value: function log() {
      if (this.debug) {
        ...
        (_console = console).log.apply(_console, ["DEBUG [".concat(this.constructor.name, "]:")].concat(args));
      }
    }
  }, {
    key: "logObject",
    value: function logObject() {
      if (this.debug) {
        var _console2;
        console.log("DEBUG OBJECT [".concat(this.constructor.name, "]:"));
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ CommandCenterGraphic)
/* harmony export */ });
/* harmony import */ var _utils_helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(406);
/* harmony import */ var _base_base_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(388);
/* harmony import */ var _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(200);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var CommandCenterGraphic = /*#__PURE__*/function (_Base) {
  function CommandCenterGraphic(elementId) {
    var _this;
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    _classCallCheck(this, CommandCenterGraphic);
    _this = _callSuper(this, CommandCenterGraphic, [options.debug || false]);
    ...
    _this.options = _objectSpread({
      ...
      refinementConnection: null,
      // Which specific connection to refine
      connectionRepeatDelay: 2000
    }, options);
    if (!elementId) {
      _this.log('No element ID provided. Please provide a valid ID.', 'error');
      return _possibleConstructorReturn(_this);
    }
    _this.elementId = elementId;
    _this.element = (0,_utils_helpers_js__WEBPACK_IMPORTED_MODULE_1__/* .selectId */ .Ge)(elementId);
    if (!_this.element) {
      _this.log("Element with ID \"".concat(elementId, "\" not found. Please provide a valid ID."), 'error');
      return _possibleConstructorReturn(_this);
    }
    _this.log("Initializing with ID \"".concat(elementId, "\""), 'info');

    // Convert NodeList to Array for easier manipulation
    _this.tiles = Array.from(_this.element.querySelectorAll('.cc-block-item .fuller-cube-outline:not(.fco__accent)'));
    _this.log("Found ".concat(_this.tiles.length, " tiles"), 'info');
    _this.centerTile = _this.element.querySelector('.cc-block-item .fuller-cube-outline.fco__accent');
    _this.log("Center Tile: ".concat(_this.centerTile), 'info');

    // Animation configuration objects
    _this.initializeConfigurations();

    // Track animation state
    _this.iterationCount = 0;

    // Map tile indexes to position names for easier reference
    _this.positionMap = ['top-left', 'top-middle', 'top-right', 'middle-left', 'middle-right', 'bottom-left', 'bottom-middle', 'bottom-right'];
  ...
  _inherits(CommandCenterGraphic, _Base);
  return _createClass(CommandCenterGraphic, [{
    key: "initializeConfigurations",
    value: function initializeConfigurations() {
      ...
      this.offsetConfig = {
        ...
        direction: {
          ...
          diagonal: {
            multiplier: 1.1
          } // Multiplier for diagonal connections
        }
      };
    }
    ...
    key: "setupConnectionsContainer",
    value: function setupConnectionsContainer() {
      ...
      var gridContainer = this.element.querySelector('.network-grid-container');
    ...
    value: function init() {
      ...
      _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.set(this.tiles, {
        x: -20,
        opacity: 0
      });
      _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.set(this.centerTile, {
        y: 20,
        opacity: 0
      });
      _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(this.tiles, {
        x: 0,
        opacity: 1,
        ...
        onComplete: function onComplete() {
          _this2.log("Reveal animation complete.");

          // After the reveal animation completes, decide what to do based on mode
          if (_this2.options.devMode) {
            _this2.log('Starting development mode...');
            if (_this2.options.testConnections) {
              // If in test connections mode, start mapping connections
              setTimeout(function () {
                return _this2.startConnectionMapping();
              }, 1000);
            } else if (_this2.options.refinementMode) {
              // If in refinement mode, test the specific connection
              setTimeout(function () {
                return _this2.startConnectionRefinement();
              }, 1000);
            } else {
              // Otherwise default to normal mode
              setTimeout(function () {
                return _this2.startIntelligentNetwork();
              }, _this2.timingConfig.testing.animationDelay);
            }
          } else {
            // Normal animation mode
            _this2.log('Starting intelligent network animation...');
            setTimeout(function () {
              return _this2.startIntelligentNetwork();
            }, _this2.timingConfig.testing.animationDelay);
          }
      ...
      _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(this.centerTile, {
        y: 0,
        opacity: 1,
        duration: this.timingConfig.reveal.duration,
    ...
    key: "addDevConsoleCommands",
    value: function addDevConsoleCommands() {
    ...
    value: function stopAllAnimations() {
      ...
      _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.killTweensOf(this.tiles);
      _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.killTweensOf(this.centerTile);
    ...
    key: "startIntelligentNetwork",
    value: function startIntelligentNetwork() {
    ...
    key: "scheduleNextMovement",
    value: function scheduleNextMovement() {
      var _this3 = this;
      // Randomize the delay before the next movement (between min and max)
      var minDelay = this.timingConfig.network.movementInterval.min;
      var maxDelay = this.timingConfig.network.movementInterval.max;
      var nextDelay = minDelay + Math.random() * (maxDelay - minDelay);
      this.nextMovementTimeout = setTimeout(function () {
        // Decide which type of movement to perform
        var movementType = Math.random();
        if (movementType < 0.25) {
          // 25% chance: Move all tiles clockwise
          _this3.moveClockwise(_this3.easingConfig.movement.clockwise, _this3.timingConfig.network.movementDuration);
        } else if (movementType < 0.4) {
          // 15% chance: Move all tiles counterclockwise
          _this3.moveCounterClockwise(_this3.easingConfig.movement.counterClockwise, _this3.timingConfig.network.movementDuration);
        } else if (movementType < 0.7) {
          // 30% chance: Swap a pair of tiles
          _this3.swapRandomPair();
        } else {
          // 30% chance: Move a small group in a pattern
          _this3.movePatternGroup();
        }

        // Schedule the next movement
        _this3.scheduleNextMovement();
      }, nextDelay);
    }
  }, {
    key: "startRandomPulses",
    value: function startRandomPulses() {
      var _this4 = this;
      ...
      var _startPulse = function startPulse() {
        ...
        if (_this4.activeTileMovement) {
          var retryDelay = _this4.timingConfig.network.pulseFrequency.base / 2;
          _this4.nextPulseTimeout = setTimeout(_startPulse, retryDelay);
          return;
        }
        var randomIndex = Math.floor(Math.random() * _this4.tiles.length);
        var tile = _this4.tiles[randomIndex];

        // Create pulse animation
        var pulseAnim = _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.timeline();

        // Add subtle glow - using configuration values
        pulseAnim.to(tile, {
          scale: _this4.styleConfig.pulse.normal.scale,
          filter: _this4.styleConfig.pulse.normal.filter,
          duration: _this4.timingConfig.network.pulseDuration,
          ease: _this4.easingConfig.pulse["in"]
        });
        ...
        pulseAnim.to(tile, {
          ...
          filter: 'brightness(1)',
          duration: _this4.timingConfig.network.pulseDuration,
          ease: _this4.easingConfig.pulse.out
        });

        // Add to active animations
        _this4.activeAnimations.pulses.push(pulseAnim);

        // Schedule the next random pulse with variation
        var baseDelay = _this4.timingConfig.network.pulseFrequency.base;
        var variation = _this4.timingConfig.network.pulseFrequency.variation;
        var nextDelay = baseDelay * (1 - variation + Math.random() * variation * 2);
        _this4.nextPulseTimeout = setTimeout(_startPulse, nextDelay);
      };
    ...
    key: "startRandomConnections",
    value: function startRandomConnections() {
      var _this5 = this;
      // Start random connection animations between tiles
      var _startConnection = function startConnection() {
        // Select two random tiles to connect
        var allIndexes = Array.from({
          length: _this5.tiles.length
        }, function (_, i) {
          return i;
        });
        var randomIndexes = _this5.shuffleArray(allIndexes).slice(0, 2);
        var tile1 = _this5.tiles[randomIndexes[0]];
        var tile2 = _this5.tiles[randomIndexes[1]];

        // Create and animate the connection
        var connectionAnim = _this5.createConnection(tile1, tile2);
        _this5.activeAnimations.connections.push(connectionAnim);

        // Schedule the next random connection with variation
        var baseDelay = _this5.timingConfig.network.connectionFrequency.base;
        var variation = _this5.timingConfig.network.connectionFrequency.variation;
        var nextDelay = baseDelay * (1 - variation + Math.random() * variation * 2);
        _this5.nextConnectionTimeout = setTimeout(_startConnection, nextDelay);
      };
    ...
    key: "startBrainPulses",
    value: function startBrainPulses() {
      var _this6 = this;
      // Start periodic "brain" pulses from the center tile
      var _startBrainPulse = function startBrainPulse() {
        _this6.log('Triggering brain pulse from center');

        // Create a ripple effect from the center tile
        var pulseAnim = _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.timeline();

        // Pulse the center tile
        pulseAnim.to(_this6.centerTile, {
          scale: _this6.styleConfig.pulse.brain.scale,
          filter: _this6.styleConfig.pulse.brain.filter,
          duration: _this6.timingConfig.network.brainPulseDuration,
          ease: _this6.easingConfig.brainPulse["in"]
        });
        ...
        pulseAnim.to(_this6.centerTile, {
          ...
          filter: 'none',
          duration: _this6.timingConfig.network.brainPulseDuration,
          ease: _this6.easingConfig.brainPulse.out
        });

        // Affect surrounding tiles
        _this6.tiles.forEach(function (tile, index) {
          // Stagger effect radiating from center
          var delay = 0.05 * (index % 4);

          // Create a smaller pulse on each surrounding tile
          _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.timeline().to(tile, {
            scale: _this6.styleConfig.pulse.ripple.scale,
            filter: _this6.styleConfig.pulse.ripple.filter,
            duration: _this6.timingConfig.network.brainPulseDuration / 2,
            delay: delay,
            ease: _this6.easingConfig.brainPulse.rippleIn
          }).to(tile, {
            scale: 1,
            filter: 'none',
            duration: _this6.timingConfig.network.brainPulseDuration / 2,
            ease: _this6.easingConfig.brainPulse.rippleOut
          });
        });
        ...
        setTimeout(function () {
          ...
          var numConnections = 3 + Math.floor(Math.random() * 2);
          var shuffledTiles = _this6.shuffleArray(_toConsumableArray(_this6.tiles)).slice(0, numConnections);
          shuffledTiles.forEach(function (tile, i) {
            setTimeout(function () {
              _this6.createConnection(_this6.centerTile, tile, 0.7, _this6.styleConfig.connection.brain);
            }, i * 200);
          });
        }, 700);

        // Store animation reference
        _this6.activeAnimations.brainPulse = pulseAnim;

        // Schedule the next brain pulse with slight variation
        var baseDelay = _this6.timingConfig.network.brainPulseFrequency.base;
        var variation = _this6.timingConfig.network.brainPulseFrequency.variation;
        var nextDelay = baseDelay * (1 - variation + Math.random() * variation * 2);
        _this6.nextBrainPulseTimeout = setTimeout(_startBrainPulse, nextDelay);
      };

      // Start the brain pulse cycle
      setTimeout(_startBrainPulse, this.timingConfig.network.brainPulseFrequency.base / 2);
    }

    // Creates a connection line between two elements
  }, {
    key: "createConnection",
    value: function createConnection(element1, element2) {
      var _this7 = this;
      ...
      var connectionDuration = duration || this.timingConfig.network.connectionDuration;

      // Use the configured style or provided style
      var connectionStyle = style || this.styleConfig.connection.normal;
      ...
      var containerRect = this.connectionsContainer.getBoundingClientRect();
      ...
      // Get position names
      var fromPositionName = "default";
      var toPositionName = "default";

      // Determine if center tile is involved
      var isFromCenter = element1 === this.centerTile;
      var isToCenter = element2 === this.centerTile;
      if (isFromCenter) {
        fromPositionName = "center";
      } else {
        // Find the element index in tiles array
        var index = this.tiles.indexOf(element1);
        if (index !== -1) {
      ...
      if (isToCenter) {
        ...
        // Find the element index in tiles array
        var _index = this.tiles.indexOf(element2);
        if (_index !== -1) {
          toPositionName = this.positionMap[_index];
        }
      }

      // Build connection key
      var connectionKey = "".concat(fromPositionName, "-to-").concat(toPositionName);

      // If connection doesn't exist in that direction, try the reverse
      if (!this.connectionMap[connectionKey]) {
        var reverseKey = "".concat(toPositionName, "-to-").concat(fromPositionName);
        if (this.connectionMap[reverseKey]) {
          // Use reverse connection data but swap from/to
          connectionKey = reverseKey;
        }
      }
      var fromOffsetX, fromOffsetY, toOffsetX, toOffsetY;

      // Use connection map if available
      if (this.connectionMap[connectionKey]) {
        var connectionData = this.connectionMap[connectionKey];

        // If we had to use the reverse key, swap from/to
        if (connectionKey === "".concat(toPositionName, "-to-").concat(fromPositionName)) {
        ...
        var fromOffsets = this.calculateOffsetFactors(fromPositionName, Math.atan2(dir.y, dir.x) * (180 / Math.PI));
        var toOffsets = this.calculateOffsetFactors(toPositionName, (Math.atan2(dir.y, dir.x) * (180 / Math.PI) + 180) % 360);
      ...
      // Animate the line
      var lineAnim = _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.timeline({
        onComplete: function onComplete() {
          // Remove the line after animation completes
          if (_this7.connectionsContainer.contains(line)) {
            _this7.connectionsContainer.removeChild(line);
          }
        }
      });
    ...
    key: "calculateOffsetFactors",
    value: function calculateOffsetFactors(positionName, angle) {
      // Default factors
      var factorX = this.offsetConfig["default"].factorX;
      var factorY = this.offsetConfig["default"].factorY;

      // Position-specific factors if available
      if (this.offsetConfig.position[positionName]) {
        var positionRules = this.offsetConfig.position[positionName];

        // Find a matching angle rule
        var _iterator = _createForOfIteratorHelper(positionRules),
          _step;
        try {
    ...
    value: function swapRandomPair() {
      ...
      var swapPair = this.shuffleArray(allIndexes).slice(0, 2);
      var tile1 = this.tiles[swapPair[0]];
      var tile2 = this.tiles[swapPair[1]];

      // Get positions
      var pos1 = positions[swapPair[0]];
      var pos2 = positions[swapPair[1]];

      // Create a connection between them before swapping
      this.createConnection(tile1, tile2, 0.8);

      // Animate the swap
      _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(tile1, {
        x: "+=".concat(pos2.x - pos1.x),
        y: "+=".concat(pos2.y - pos1.y),
        duration: 1,
        ease: this.easingConfig.movement.swapPair,
        delay: 0.3
      });
      _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(tile2, {
        x: "+=".concat(pos1.x - pos2.x),
        y: "+=".concat(pos1.y - pos2.y),
        duration: 1,
        ease: this.easingConfig.movement.swapPair,
        delay: 0.3,
        onComplete: function onComplete() {
          // Movement is done
          _this8.activeTileMovement = false;
        }
      });
    }
  }, {
    key: "movePatternGroup",
    value: function movePatternGroup() {
      var _this9 = this;
      ...
      if (patternType === 0) {
        ...
        moveTargets = _defineProperty(_defineProperty(_defineProperty({}, groupIndexes[0], groupIndexes[1]), groupIndexes[1], groupIndexes[2]), groupIndexes[2], groupIndexes[0]);
      } else if (patternType === 1) {
        // Square rotation (4 tiles in corners rotate)
        groupIndexes = [0, 2, 7, 5]; // top-left, top-right, bottom-right, bottom-left
        moveTargets = _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, groupIndexes[0], groupIndexes[1]), groupIndexes[1], groupIndexes[2]), groupIndexes[2], groupIndexes[3]), groupIndexes[3], groupIndexes[0]);
      } else {
        // Row or column shift
        var isRow = Math.random() > 0.5;
        if (isRow) {
          // Shift a row (top, middle, or bottom)
          var rowToShift = Math.floor(Math.random() * 3);
          if (rowToShift === 0) {
            groupIndexes = [0, 1, 2]; // Top row
            moveTargets = _defineProperty(_defineProperty(_defineProperty({}, groupIndexes[0], groupIndexes[1]), groupIndexes[1], groupIndexes[2]), groupIndexes[2], groupIndexes[0]);
          } else if (rowToShift === 1) {
            groupIndexes = [3, 4]; // Middle row (excluding center)
            moveTargets = _defineProperty(_defineProperty({}, groupIndexes[0], groupIndexes[1]), groupIndexes[1], groupIndexes[0]);
          } else {
          ...
          var colToShift = Math.floor(Math.random() * 3);
          if (colToShift === 0) {
      ...
      var _loop = function _loop() {
        var currentIndex = groupIndexes[i];
        var nextIndex = groupIndexes[(i + 1) % groupIndexes.length];
        setTimeout(function () {
          _this9.createConnection(_this9.tiles[currentIndex], _this9.tiles[nextIndex], 0.7);
        }, i * 150);
      };
      ...
      setTimeout(function () {
        ...
        groupIndexes.forEach(function (index) {
          var targetIndex = moveTargets[index];
          var currentTile = _this9.tiles[index];
          ...
          _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(currentTile, {
            x: "+=".concat(dx),
            y: "+=".concat(dy),
            duration: _this9.timingConfig.network.movementDuration,
            ease: _this9.easingConfig.movement.patternGroup,
            onComplete: function onComplete() {
              completedMoves++;
              if (completedMoves === groupIndexes.length) {
                // All moves complete
                _this9.activeTileMovement = false;
              }
            }
          });
        });
    ...
    value: function getTilePositions() {
      ...
      positions.forEach(function (pos) {
        var tile = _this10.tiles[pos.index];
        var rect = tile.getBoundingClientRect();
        pos.x = rect.left;
        pos.y = rect.top;
        _this10.log("Position ".concat(pos.name, " (").concat(pos.index, "): (").concat(pos.x, ", ").concat(pos.y, ")"));
      });
      return positions;
    }
  }, {
    key: "moveClockwise",
    value: function moveClockwise() {
      var _this11 = this;
      var easing = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'power2.inOut';
      var duration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1.5;
      this.log("Moving tiles clockwise with ".concat(easing, " easing"));
      ...
      var moveTargets = [1,
      // DOM tile 0 (top-left) moves to position 1 (top-middle) 
      2,
      // DOM tile 1 (top-middle) moves to position 2 (top-right)
      4,
      // DOM tile 2 (top-right) moves to position 4 (middle-right)
      0,
      // DOM tile 3 (middle-left) moves to position 0 (top-left)
      7,
      // DOM tile 4 (middle-right) moves to position 7 (bottom-right)
      3,
      // DOM tile 5 (bottom-left) moves to position 3 (middle-left)
      5,
      // DOM tile 6 (bottom-middle) moves to position 5 (bottom-left)
      ...
      this.tiles.forEach(function (tile, index) {
        ...
        var targetPosition = positions[moveTargets[index]];

        // Calculate the required movement
        var currentRect = tile.getBoundingClientRect();
        var dx = targetPosition.x - currentRect.left;
        var dy = targetPosition.y - currentRect.top;
        _this11.log("Moving tile ".concat(index, " to ").concat(targetPosition.name, " (position ").concat(moveTargets[index], ")"));

        // Animate the tile to the new position
        _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(tile, {
          x: "+=".concat(dx),
          y: "+=".concat(dy),
          duration: duration,
          delay: index * _this11.timingConfig.network.movementStaggerDelay,
          ease: easing,
          onStart: function onStart() {
            _this11.log("Starting clockwise animation for tile ".concat(index));
          },
          onComplete: function onComplete() {
            _this11.log("Completed clockwise animation for tile ".concat(index));
            completedMoves++;
            if (completedMoves === _this11.tiles.length) {
              // All moves complete
              _this11.activeTileMovement = false;
            }
          }
        });
      });
    ...
    key: "moveCounterClockwise",
    value: function moveCounterClockwise() {
      var _this12 = this;
      var easing = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'power2.inOut';
      var duration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1.5;
      this.log("Moving tiles counter-clockwise with ".concat(easing, " easing"));
      ...
      var moveTargets = [3,
      // DOM tile 0 (top-left) → position 3 (middle-left)
      0,
      // DOM tile 1 (top-middle) → position 0 (top-left)
      1,
      // DOM tile 2 (top-right) → position 1 (top-middle)
      5,
      // DOM tile 3 (middle-left) → position 5 (bottom-left)
      2,
      // DOM tile 4 (middle-right) → position 2 (top-right)
      6,
      // DOM tile 5 (bottom-left) → position 6 (bottom-middle)
      7,
      // DOM tile 6 (bottom-middle) → position 7 (bottom-right)
      ...
      this.tiles.forEach(function (tile, index) {
        ...
        var dx = targetPosition.x - currentRect.left;
        var dy = targetPosition.y - currentRect.top;
        _this12.log("Moving tile ".concat(index, " to ").concat(targetPosition.name, " (position ").concat(moveTargets[index], ")"));
        ...
        _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(tile, {
          ...
          y: "+=".concat(dy),
          duration: duration,
          delay: index * _this12.timingConfig.network.movementStaggerDelay,
          ease: easing,
          onStart: function onStart() {
            _this12.log("Starting counter-clockwise animation for tile ".concat(index));
          },
          onComplete: function onComplete() {
            _this12.log("Completed counter-clockwise animation for tile ".concat(index));
            completedMoves++;
            if (completedMoves === _this12.tiles.length) {
              // All moves complete
              _this12.activeTileMovement = false;
            }
          }
        });
      });
    ...
    key: "startConnectionMapping",
    value: function startConnectionMapping() {
      var _this13 = this;
      ...
      var originalAnimationDelay = this.timingConfig.testing.animationDelay;

      // Create a connection map data structure
      this.connectionMap = {};

      // Generate all possible tile pairs
      var tilePairs = this.generateAllTilePairs();
      ...
      // Test a single pair
      var _testPair = function testPair(pair) {
        // Clear any previous connections and helpers
        _this13.clearTestElements();

        // Create a header message
        _this13.log("Testing connection ".concat(currentPairIndex + 1, "/").concat(tilePairs.length, ": ").concat(pair.desc), 'info');
        console.log("%c Testing: ".concat(pair.desc, " "), 'background: #444; color: #ff9; padding: 3px;');

        // Get the elements
        var fromElement, toElement;
        if (pair.fromCenter) {
          fromElement = _this13.centerTile;
        } else {
          fromElement = _this13.tiles[pair.from];
        }
        if (pair.toCenter) {
          toElement = _this13.centerTile;
        } else {
          toElement = _this13.tiles[pair.to];
        }

        // Get element information
        var rect1 = fromElement.getBoundingClientRect();
        var rect2 = toElement.getBoundingClientRect();

        // Adjust positions to be relative to the connections container
        var containerRect = _this13.connectionsContainer.getBoundingClientRect();
        ...
        var fromOffsets = _this13.calculateAdaptiveOffsets(pair.fromName, angle, rect1.width, rect1.height, true);
        var toOffsets = _this13.calculateAdaptiveOffsets(pair.toName, (angle + 180) % 360, rect2.width, rect2.height, false);

        // Store calculated offsets in the connection map
        _this13.connectionMap[pair.key] = {
          from: {
            position: pair.fromName,
        ...
        _this13.drawTestHelpers(center1, center2, fromPoint, toPoint);

        // Create connection with calculated offsets
        _this13.createTestConnection(fromPoint, toPoint, 10);

        // Output current map entry
        console.log('Current map entry:', _defineProperty({}, pair.key, _this13.connectionMap[pair.key]));
        ...
        if (currentPairIndex >= tilePairs.length) {
          _this13.log('Connection mapping complete!', 'info');
          console.log('%c CONNECTION MAPPING COMPLETE ', 'background: #060; color: white; padding: 5px;');
          console.log('Full connection map:');
          console.log(JSON.stringify(_this13.connectionMap, null, 2));

          // Create a cleaned version of the map without test factors
          var cleanMap = {};
          Object.keys(_this13.connectionMap).forEach(function (key) {
            cleanMap[key] = {
              from: {
                position: _this13.connectionMap[key].from.position,
                offsetX: _this13.connectionMap[key].from.offsetX,
                offsetY: _this13.connectionMap[key].from.offsetY
              },
              to: {
                position: _this13.connectionMap[key].to.position,
                offsetX: _this13.connectionMap[key].to.offsetX,
                offsetY: _this13.connectionMap[key].to.offsetY
              }
            };
          });
          ...
          _this13.timingConfig.testing.animationDelay = originalAnimationDelay;
        ...
        _this13.nextConnectionMappingTimeout = setTimeout(function () {
          _testPair(tilePairs[currentPairIndex]);
        }, _this13.timingConfig.testing.connectionTestDelay);
      };

      // Start with the first pair
      _testPair(tilePairs[0]);
    }

    // Calculate adaptive offsets based on element position and connection angle
  }, {
    key: "calculateAdaptiveOffsets",
    value: function calculateAdaptiveOffsets(position, angle, width, height, isFrom) {
      // Initialize with default values
      var offsetX = Math.min(width, height) * 0.4;
      var offsetY = Math.min(width, height) * 0.4;
    ...
    key: "initializeTestHelpers",
    value: function initializeTestHelpers() {
    ...
    key: "clearTestElements",
    value: function clearTestElements() {
    ...
    key: "drawTestHelpers",
    value: function drawTestHelpers(center1, center2, fromPoint, toPoint) {
      // Draw center points
    ...
    value: function drawPoint(x, y, color) {
      var radius = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    ...
    value: function drawLine(x1, y1, x2, y2, color) {
      ...
      var dashed = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : false;
    ...
    key: "createTestConnection",
    value: function createTestConnection(fromPoint, toPoint) {
      var duration = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      // Use configured test style
      var testStyle = this.styleConfig.connection.testing;
      var testDuration = duration || 5;
      ...
      _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.fromTo(line, {
        opacity: 0
      }, {
        opacity: 1,
        duration: this.timingConfig.testing.visualDuration
      });
      return line;
    }
    ...
    key: "generateAllTilePairs",
    value: function generateAllTilePairs() {
      var pairs = [];
      ...
      for (var i = 0; i < this.tiles.length; i++) {
        for (var j = i + 1; j < this.tiles.length; j++) {
          pairs.push({
            ...
            fromCenter: false,
            toCenter: false,
            key: "".concat(this.positionMap[i], "-to-").concat(this.positionMap[j]),
            desc: "".concat(this.positionMap[i], " to ").concat(this.positionMap[j])
          });
        }
      }
      ...
      for (var _i = 0; _i < this.tiles.length; _i++) {
        pairs.push({
          from: _i,
          to: 'center',
          fromName: this.positionMap[_i],
          toName: 'center',
          fromCenter: false,
          toCenter: true,
          key: "".concat(this.positionMap[_i], "-to-center"),
          desc: "".concat(this.positionMap[_i], " to center")
        });
      }
      return pairs;
    }
    ...
    key: "startConnectionRefinement",
    value: function startConnectionRefinement() {
      var _this14 = this;
      ...
      var connectionKey = this.options.refinementConnection;
      if (!connectionKey) {
        this.log('No connection specified for refinement. Please set options.refinementConnection', 'error');
        return;
      }
      if (!this.connectionMap[connectionKey]) {
        this.log("Connection \"".concat(connectionKey, "\" not found in connection map"), 'error');
        return;
      }
      this.log("Refining connection: ".concat(connectionKey), 'info');

      // Initialize visual test helpers
      this.initializeTestHelpers();

      // Function to test this connection repeatedly
      var _testConnection = function testConnection() {
        // Clear any previous test elements
        _this14.clearTestElements();

        // Get endpoints for this connection
        var connectionData = _this14.parseConnectionKey(connectionKey);
        if (!connectionData) return;
        var fromElement = connectionData.fromElement,
          toElement = connectionData.toElement;

        // Get current connection settings
        var currentSettings = _this14.connectionMap[connectionKey];
        ...
        // Adjust positions to be relative to the connections container
        var containerRect = _this14.connectionsContainer.getBoundingClientRect();
        ...
        // Draw test helpers to visualize
        _this14.drawTestHelpers(center1, center2, fromPoint, toPoint);

        // Create connection
        _this14.createTestConnection(fromPoint, toPoint, 5);

        // Schedule the next test
        _this14.nextRefinementTimeout = setTimeout(_testConnection, _this14.options.connectionRepeatDelay);
      };
    ...
    key: "parseConnectionKey",
    value: function parseConnectionKey(key) {
      // Split the key to get position names
      var parts = key.split('-to-');
      if (parts.length !== 2) {
        this.log("Invalid connection key format: ".concat(key), 'error');
        return null;
      }
      var fromPositionName = parts[0];
      var toPositionName = parts[1];
      ...
      if (fromPositionName === 'center') {
        ...
        var fromIndex = this.positionMap.indexOf(fromPositionName);
        if (fromIndex === -1) {
          this.log("Invalid from position: ".concat(fromPositionName), 'error');
          return null;
        }
      ...
      if (toPositionName === 'center') {
        ...
        var toIndex = this.positionMap.indexOf(toPositionName);
        if (toIndex === -1) {
          this.log("Invalid to position: ".concat(toPositionName), 'error');
          return null;
        }
...
}(_base_base_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A);
// Static connection map with refined connection points
_defineProperty(CommandCenterGraphic, "CONNECTION_MAP", {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ ContactForm)
/* harmony export */ });
if (152 != __webpack_require__.j) {
	/* harmony import */ var _utils_helpers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(406);
}
if (152 != __webpack_require__.j) {
	/* harmony import */ var _base_base_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(388);
}
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
...
var ContactForm = /*#__PURE__*/(/* runtime-dependent pure expression or super */ 152 != __webpack_require__.j ? (function (_Base) {
  function ContactForm(elementId) {
    var _this;
    var debug = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    _classCallCheck(this, ContactForm);
    _this = _callSuper(this, ContactForm, [debug]);
    if (!elementId) return _possibleConstructorReturn(_this);
    _this.log("initialized with elementId: ".concat(elementId));
    _this.element = (0,_utils_helpers_js__WEBPACK_IMPORTED_MODULE_0__/* .selectId */ .Ge)(elementId);
    _this.triggerSelect = _this.element.querySelector('#fuller-Interest');
    _this.multiSelectContainer = _this.element.querySelector('#multi-select-container');
    _this.triggerValue = 'Product Inquiry';
    if (!_this.element) {
      _this.log("Element with ID ".concat(elementId, " not found."));
      return _possibleConstructorReturn(_this);
    }
    _this.init();
    return _this;
  }
  _inherits(ContactForm, _Base);
  return _createClass(ContactForm, [{
    key: "init",
    value: function init() {
      var _this2 = this;
      this.multiSelectContainer.style.display = 'none';
      (0,_utils_helpers_js__WEBPACK_IMPORTED_MODULE_0__.on)(this.triggerSelect, 'change', function () {
        if (_this2.triggerSelect.value === _this2.triggerValue) {
          _this2.multiSelectContainer.style.display = 'block';
        } else {
          _this2.multiSelectContainer.style.display = 'none';
        }
      });
    }
  }]);
}(_base_base_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)) : null);
...
__webpack_require__.d(__webpack_exports__, {
  A: () => (/* binding */ TextAnimateSections)
});

// EXTERNAL MODULE: ./project/src/utils/helpers.js
var helpers = __webpack_require__(406);
// EXTERNAL MODULE: ./project/src/utils/animation.js + 6 modules
var animation = __webpack_require__(200);
// EXTERNAL MODULE: ./project/src/modules/base/base.js
var base = __webpack_require__(388);
...
var TEXT_REVEAL_SELECTOR = '[data-reveal]';
var TextAnimateLines = /*#__PURE__*/function (_Base) {
  function TextAnimateLines(elementId) {
    var _this;
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var debug = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    _classCallCheck(this, TextAnimateLines);
    _this = _callSuper(this, TextAnimateLines, [debug]);
    _this.elementId = elementId;
    _this.container = (0,helpers/* selectId */.Ge)(elementId);
    if (!_this.container) {
      _this.log("Element with ID ".concat(elementId, " not found."));
      return _possibleConstructorReturn(_this);
    }
  ...
  _inherits(TextAnimateLines, _Base);
  return _createClass(TextAnimateLines, [{
    key: "init",
    value: function init() {
      this.setInitialStyles();
      this.splitRevealElements();
      this.createScrollTriggerAnimation();
      if (window.innerWidth < 768 && this.options.handleResizeOnMobile || window.innerWidth >= 768) {
    ...
    key: "wrapLineContents",
    value: function wrapLineContents() {
      var _this2 = this;
      this.allLinesCopy = [];
      this.splitInstances.forEach(function (instance) {
        if (instance.lines) {
          instance.lines.forEach(function (line, lineIndex) {
            // fix trailing periods...
            if (line.textContent.trim() === '.' && lineIndex > 0) {
              var previousCopyWrapper = _this2.allLinesCopy[_this2.allLinesCopy.length - 1];
              ...
              _this2.allLinesCopy.push(copyWrapper);
            }
          });
        }
      });
    ...
    value: function splitRevealElements() {
      ...
      var revealElements = this.container.querySelectorAll(TEXT_REVEAL_SELECTOR);
      revealElements.forEach(function (element) {
        var splitInstance = new animation/* SplitType */.BX(element, {
          types: _this3.options.types
        });
        _this3.splitInstances.push(splitInstance);
      });
    ...
    value: function createScrollTriggerAnimation() {
      ...
      var tl = animation/* gsap */.os.timeline({
        scrollTrigger: _objectSpread(_objectSpread({}, this.options.scrollTrigger), {}, {
          onEnter: function onEnter() {
            var _this4$options;
            // console.log('onEnter', this.elementId);
            if (typeof ((_this4$options = _this4.options) === null || _this4$options === void 0 ? void 0 : _this4$options.onEnter) === 'function') {
              _this4.options.onEnter();
            }
          },
          onComplete: function onComplete() {
            var _this4$options2;
            if (typeof ((_this4$options2 = _this4.options) === null || _this4$options2 === void 0 ? void 0 : _this4$options2.onComplete) === 'function') {
              _this4.options.onComplete();
            }
          }
        })
      });
      ...
      tl.to(this.allLinesCopy, _objectSpread({
        duration: 1.2,
        y: 0,
        stagger: 0.1,
        ease: "expo.out"
    ...
    value: function replay() {
      ...
      animation/* gsap */.os.set(this.allLinesCopy, {
        yPercent: 100
      });
      this.createScrollTriggerAnimation();
    }
    ...
    value: function destroy() {
      ...
      animation/* gsap */.os.killTweensOf(this.allLinesCopy);
      this.splitInstances.forEach(function (instance) {
        return instance.revert();
      });
...
;// ./project/src/modules/text-animate-sections/text-animate-sections.js
var _excluded = ["id"];
function _objectWithoutProperties(e, t) { if (null == e) return {}; var o, r, i = _objectWithoutPropertiesLoose(e, t); if (Object.getOwnPropertySymbols) { var n = Object.getOwnPropertySymbols(e); for (r = 0; r < n.length; r++) o = n[r], -1 === t.indexOf(o) && {}.propertyIsEnumerable.call(e, o) && (i[o] = e[o]); } return i; }
function _objectWithoutPropertiesLoose(r, e) { if (null == r) return {}; var t = {}; for (var n in r) if ({}.hasOwnProperty.call(r, n)) { if (-1 !== e.indexOf(n)) continue; t[n] = r[n]; } return t; }
function text_animate_sections_typeof(o) { "@babel/helpers - typeof"; return text_animate_sections_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, text_animate_sections_typeof(o); }
function text_animate_sections_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function text_animate_sections_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, text_animate_sections_toPropertyKey(o.key), o); } }
function text_animate_sections_createClass(e, r, t) { return r && text_animate_sections_defineProperties(e.prototype, r), t && text_animate_sections_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function text_animate_sections_toPropertyKey(t) { var i = text_animate_sections_toPrimitive(t, "string"); return "symbol" == text_animate_sections_typeof(i) ? i : i + ""; }
function text_animate_sections_toPrimitive(t, r) { if ("object" != text_animate_sections_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != text_animate_sections_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function text_animate_sections_callSuper(t, o, e) { return o = text_animate_sections_getPrototypeOf(o), text_animate_sections_possibleConstructorReturn(t, text_animate_sections_isNativeReflectConstruct() ? Reflect.construct(o, e || [], text_animate_sections_getPrototypeOf(t).constructor) : o.apply(t, e)); }
function text_animate_sections_possibleConstructorReturn(t, e) { if (e && ("object" == text_animate_sections_typeof(e) || "function" == typeof e)) return e; if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined"); return text_animate_sections_assertThisInitialized(t); }
function text_animate_sections_assertThisInitialized(e) { if (void 0 === e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return e; }
function text_animate_sections_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (text_animate_sections_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
function text_animate_sections_getPrototypeOf(t) { return text_animate_sections_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function (t) { return t.__proto__ || Object.getPrototypeOf(t); }, text_animate_sections_getPrototypeOf(t); }
function text_animate_sections_inherits(t, e) { if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function"); t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: !0, configurable: !0 } }), Object.defineProperty(t, "prototype", { writable: !1 }), e && text_animate_sections_setPrototypeOf(t, e); }
function text_animate_sections_setPrototypeOf(t, e) { return text_animate_sections_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) { return t.__proto__ = e, t; }, text_animate_sections_setPrototypeOf(t, e); }


var TextAnimateSections = /*#__PURE__*/function (_Base) {
  function TextAnimateSections(sections) {
    var _this;
    var debug = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    text_animate_sections_classCallCheck(this, TextAnimateSections);
    _this = text_animate_sections_callSuper(this, TextAnimateSections, [debug]);
    _this.debug = debug;
    if (!Array.isArray(sections) || sections.length === 0) return text_animate_sections_possibleConstructorReturn(_this);
  ...
  text_animate_sections_inherits(TextAnimateSections, _Base);
  return text_animate_sections_createClass(TextAnimateSections, [{
    key: "init",
    value: function init() {
      var _this2 = this;
      this.sections.forEach(function (params) {
        if (typeof params === 'string') {
          new TextAnimateLines(params);
        } else if (text_animate_sections_typeof(params) === 'object' && params !== null && params.id) {
          var id = params.id,
            animationOptions = _objectWithoutProperties(params, _excluded);
          new TextAnimateLines(id, animationOptions, _this2.debug);
        }
      });
    }
  }]);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  BX: () => (/* reexport */ SplitType),
  os: () => (/* reexport */ gsapWithCSS)
});
...
function createElement(name, attributes) {
  ...
  Object.keys(attributes).forEach(function (attribute) {
    ...
    if (attribute === 'children') {
      ...
      element.append.apply(element, _toConsumableArray(dist_toArray(value)));
    } else {
...
var SplitType = /*#__PURE__*/(/* runtime-dependent pure expression or super */ !/^15[28]$/.test(__webpack_require__.j) ? (function () {
...
var pick = function pick(haystack, needles) {
  return needles.reduce(function (found, needle) {
    return haystack.hasOwnProperty(needle) && (found[needle] = haystack[needle]), found;
  }, {});
};
var init_array = function init_array(n, fn) {
  return Array.from({
    length: n
  }, function (_, i) {
    return fn(i);
