...
var CommandCenterGraphic = /*#__PURE__*/(/* runtime-dependent pure expression or super */ /^(158|359)$/.test(__webpack_require__.j) ? (function (_Base) {
  ...
  return _createClass(CommandCenterGraphic, [{
    ...
    value: function animateNextIteration() {
      var _this3 = this;
      this.iterationCount++;
      var isSpecialIteration = this.iterationCount % 3 === 0;
    ...
    value: function getTilePositions() {
      ...
      positions.forEach(function (pos) {
        var tile = _this4.tiles[pos.index];
        var rect = tile.getBoundingClientRect();
        pos.x = rect.left;
        pos.y = rect.top;
        _this4.log("Position ".concat(pos.name, " (").concat(pos.index, "): (").concat(pos.x, ", ").concat(pos.y, ")"));
      });
      return positions;
    }
  }, {
    ...
    value: function moveClockwise() {
      ...
      this.tiles.forEach(function (tile, index) {
        ...
        _this5.log("Moving tile ".concat(index, " to ").concat(targetPosition.name, " (position ").concat(moveTargets[index], ")"));
        ...
        _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(tile, {
          ...
          y: "+=".concat(dy),
          duration: duration,
          delay: index * _this5.staggerDelay,
          ease: easing,
          onStart: function onStart() {
            _this5.log("Starting clockwise animation for tile ".concat(index));
          },
          onComplete: function onComplete() {
            _this5.log("Completed clockwise animation for tile ".concat(index));
          }
        });
      });
    }
    ...
    value: function moveCounterClockwise() {
      ...
      this.tiles.forEach(function (tile, index) {
        ...
        var dx = targetPosition.x - currentRect.left;
        var dy = targetPosition.y - currentRect.top;
        _this6.log("Moving tile ".concat(index, " to ").concat(targetPosition.name, " (position ").concat(moveTargets[index], ")"));
        ...
        _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(tile, {
          ...
          y: "+=".concat(dy),
          duration: duration,
          delay: index * _this6.staggerDelay,
          ease: easing,
          onStart: function onStart() {
            _this6.log("Starting counter-clockwise animation for tile ".concat(index));
          },
          onComplete: function onComplete() {
            _this6.log("Completed counter-clockwise animation for tile ".concat(index));
          }
        });
      });
    }
