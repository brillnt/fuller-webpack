...
/* harmony export */ });
if (/^(158|359)$/.test(__webpack_require__.j)) {
...
var CommandCenterGraphic = /*#__PURE__*/(/* runtime-dependent pure expression or super */ /^(158|359)$/.test(__webpack_require__.j) ? (function (_Base) {
  function CommandCenterGraphic(elementId) {
    var _this;
    var debug = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    _classCallCheck(this, CommandCenterGraphic);
    _this = _callSuper(this, CommandCenterGraphic, [debug]);
    if (!elementId) {
    ...
    _this.animationDelay = 3000;
    _this.staggerDelay = 0.022;
    _this.iterationCount = 0;
    _this.pulseFrequency = 2000; // How often pulses occur
    _this.connectionFrequency = 3500; // How often connections appear
    _this.brainPulseFrequency = 8000; // How often the center "brain" pulses
  ...
  return _createClass(CommandCenterGraphic, [{
    ...
    value: function init() {
      ...
      _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(this.tiles, {
        ...
        onComplete: function onComplete() {
          _this2.log("Reveal animation complete. Starting intelligent network animation...");
    ...
    value: function scheduleNextMovement() {
      ...
      setTimeout(function () {
        ...
        if (movementType < 0.25) {
          ...
          _this3.moveClockwise('expo.out', 1);
        } else if (movementType < 0.4) {
          // 15% chance: Move all tiles counterclockwise
          _this3.moveCounterClockwise('power4.inOut', 1.2);
    ...
    value: function startRandomPulses() {
      ...
      var _startPulse = function startPulse() {
        ...
        if (_this4.activeTileMovement) return;
        ...
        setTimeout(_startPulse, _this4.pulseFrequency * (0.5 + Math.random()));
      };
    ...
    value: function startRandomConnections() {
      ...
      var _startConnection = function startConnection() {
        ...
        _this5.createConnection(tile1, tile2);

        // Schedule the next random connection
        setTimeout(_startConnection, _this5.connectionFrequency * (0.7 + Math.random() * 0.6));
      };
      ...
      var _startBrainPulse = function startBrainPulse() {
        ...
        setTimeout(function () {
          ...
          shuffledTiles.forEach(function (tile, i) {
            setTimeout(function () {
              _this6.createConnection(_this6.centerTile, tile, 0.7, {
        ...
        setTimeout(_startBrainPulse, _this6.brainPulseFrequency * (0.9 + Math.random() * 0.2));
      };

      // Start the brain pulse cycle
      setTimeout(_startBrainPulse, this.brainPulseFrequency / 2);
    }
  }, {
    key: "createConnection",
    value: function createConnection(element1, element2) {
      var _this7 = this;
      var duration = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1.2;
      ...
      var edgeOffset1 = Math.min(rect1.width, rect1.height) * 0.4;
      var edgeOffset2 = Math.min(rect2.width, rect2.height) * 0.4;
      var edgePoint1 = {
    ...
    value: function moveClockwise() {
      ...
      this.tiles.forEach(function (tile, index) {
        ...
        _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(tile, {
          ...
          y: "+=".concat(dy),
          duration: duration,
          delay: index * _this11.staggerDelay,
          ease: easing,
    ...
    value: function moveCounterClockwise() {
      ...
      this.tiles.forEach(function (tile, index) {
        ...
        _utils_animation_js__WEBPACK_IMPORTED_MODULE_0__/* .gsap */ .os.to(tile, {
          ...
          y: "+=".concat(dy),
          duration: duration,
          delay: index * _this12.staggerDelay,
          ease: easing,
          onStart: function onStart() {
...
}(_base_base_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)) : null);
